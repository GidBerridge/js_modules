...
console.log('Importing module'); // import * as ShoppingCart from "./shoppingCart.js";
// ShoppingCart.addToCart('bread', 5)
// console.log(ShoppingCart.totalPrice);
// addToCart('bread', 5);
// console.log(price, tq);

(0, _shoppingCart.default)('pizza', 5);
(0, _shoppingCart.default)('bread', 2);
(0, _shoppingCart.default)('apples', 1);
console.log(_shoppingCart.cart); // console.log('Start fetching');
...
var stateDeepClone = (0, _lodash.default)(state); // console.log(stateClone);
